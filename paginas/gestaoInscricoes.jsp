...
"                                                    <td class='text-center'><a href='validarInscricao.php?id=\" "+id_utilizador+" \"&validar=1&curso=\""+id_curso+"\"'><button>Aceitar</button></a></td>\n" +
"                                                    <td class='text-center'><a href='validarInscricao.php?id=\" "+ id_utilizador +" \"&curso=\""+id_curso+"\"'><button>Recusar</button></a></td>\n" +
...
"                                                    <td class='text-center'>/</td>\n" +
"                                                    <td class='text-center'>/</td>\n" +
"                                                    <td class='text-center'><a href='validarInscricao.php?id=\" "+ id_utilizador +" \"&curso=\""+id_curso+"\"'><button>Expulsar</button></a></td>\n" +
"                                                </tr>");
                                }
...
"                                                    <td class='text-center'>"+ username +"</td>\n" +
"                                                    <td class='text-center'>"+ estado +"</td>\n" +
"                                                    <td class='text-center'><a href='validarInscricao.jsp?id=\" "+id_utilizador+" \"&validar=1&curso=\""+id_curso+"\"'><button>Aceitar</button></a></td>\n" +
"                                                    <td class='text-center'><a href='validarInscricao.jsp?id=\" "+ id_utilizador +" \"&curso=\""+id_curso+"\"'><button>Recusar</button></a></td>\n" +
"                                                    <td class='text-center'>/</td>\n" +
"                                                </tr>");
                                }else{
                                    out.println("<tr>\n" +
...
"                                                    <td class='text-center'>/</td>\n" +
"                                                    <td class='text-center'>/</td>\n" +
"                                                    <td class='text-center'><a href='validarInscricao.jsp?id=\" "+ id_utilizador +" \"&curso=\""+id_curso+"\"'><button>Expulsar</button></a></td>\n" +
"                                                </tr>");
                                }
...
"                                                    <td class='text-center'>"+ nome +"</td>\n" +
"                                                    <td class='text-center'>"+ estado +"</td>\n" +
"                                                    <td class='text-center'><a href='validarInscricao.jsp?id=\" "+ id_utilizador +" \"&curso=\""+id_curso+"\"'><button>Desistir</button></a></td>\n" +
